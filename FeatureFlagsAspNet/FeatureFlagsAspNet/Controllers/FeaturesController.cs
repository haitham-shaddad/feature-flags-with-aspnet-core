...
{
    [Authorize] //TODO: Should be admin only
    public class FeaturesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Title,Description")] Feature feature)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Title,Description")] Feature feature)
        {
            if (id != feature.Id)
            {
                return NotFound();
